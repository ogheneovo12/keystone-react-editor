...
export function OrderableItem(props: { elementKey: string; children: ReactNode }) {
  const { attributes, isDragging, listeners, setNodeRef, transform, transition, index } = useSortable({
    id: props.elementKey,
  })
...
export function RemoveButton() {
  ...
  return (
    <Button weight="none" css={{ padding: 7 }} onClick={() => onRemove(sortable.index)} aria-label="Remove">
