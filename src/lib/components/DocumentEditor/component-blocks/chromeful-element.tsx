...
import { FormValueContentFromPreviewProps, type NonChildFieldComponentSchema } from './form-from-preview'
...
export function ChromefulComponentBlockElement(props: {
  ...
  const isValid = useMemo(
    () => clientSideValidateProp({ kind: 'object', fields: props.componentBlock.schema }, props.elementProps),
