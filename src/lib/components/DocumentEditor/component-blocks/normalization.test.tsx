...
test('extra component props are removed', () => {
  let editor = makeEditor(
    <editor>
      ...
      <component-block component="withChildElements" props={{ prop: '', block: null, inline: null }}>
...
test('props in wrong order', () => {
  let editor = makeEditor(
    <editor>
      <component-block component="withLotsOfChildElements" props={{ last: null, block: null, inline: null }}>
...
test('normalization adds missing fields for conditional fields', () => {
  const editor = makeEditor(
    <editor>
      <component-block component="basic" props={{ a: { discriminant: 'a', value: { something: '' } } }}>
        <component-inline-prop>
          <text />
        </component-inline-prop>
      </component-block>
