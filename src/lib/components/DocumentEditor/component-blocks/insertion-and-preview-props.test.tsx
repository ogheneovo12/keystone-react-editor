  ...
  complex: component({
    preview: (props) => {
      return React.createElement(
        ...
        props.fields.object.fields.conditional.discriminant && props.fields.object.fields.conditional.value.element,
      )
    },
    label: 'Complex',
    schema: {
...
test('preview props conditional change', () => {
  ...
  expect(getPreviewProps(editor).fields.object.fields.conditional).toEqual(expectedConditionalPreviewProps)
})
...
test('changing conditional with form inside', () => {
  ...
  `)
  const conditionalSelectPreviewProps = getPreviewProps(editor).fields.object.fields.conditionalSelect
  ...
  expect(getPreviewProps(editor).fields.object.fields.conditionalSelect).toEqual(expectedConditionalSelectPreviewProps)
})
