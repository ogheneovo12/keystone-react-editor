...
export const isElementActive = (editor: Editor, format: Exclude<ElementFromValidation, { text: string }>['type']) => {
...
export function useElementWithSetNodes<TElement extends Element>(editor: Editor, element: TElement) {
...
export function insertNodesButReplaceIfSelectionIsAtEmptyParagraphOrHeading(editor: Editor, nodes: Node | Node[]) {
