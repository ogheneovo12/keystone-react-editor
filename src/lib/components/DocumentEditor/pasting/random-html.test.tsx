...
test('inline elements containing only whitespace are preserved', () => {
  expect(htmlToEditor('<p>blah<span> </span>more<span>\n</span>other</p>\n<span>   \n </span>    <p>other</p>'))
...
test('list items', () => {
  expect(htmlToEditor('<ul><li>blah<strong> this is bold</strong><ul><li>inner</li></ul></li></ul>'))
    .toMatchInlineSnapshot(`
    <editor>
      <unordered-list>
        <list-item>
...
test('link, block and text as siblings', () => {
  expect(htmlToEditor('<a href="https://keystonejs.com">Something</a><h1>a</h1>other')).toMatchInlineSnapshot(`
    <editor>
      <paragraph>
        <text />
        <link
