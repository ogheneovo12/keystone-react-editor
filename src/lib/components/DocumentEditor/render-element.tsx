...
export const renderElement = (props: RenderElementProps) => {
  switch (props.element.type) {
    case 'layout':
      return <LayoutContainer attributes={props.attributes} children={props.children} element={props.element} />
    case 'layout-area':
      return <LayoutArea {...props} />
    case 'code':
      return <CodeElement {...props} />
    case 'component-block': {
      return <ComponentBlocksElement attributes={props.attributes} children={props.children} element={props.element} />
    }
    case 'component-inline-prop':
    case 'component-block-prop':
      return <ComponentInlineProp {...props} />
    case 'heading':
      return <HeadingElement attributes={props.attributes} children={props.children} element={props.element} />
    case 'link':
      return <LinkElement attributes={props.attributes} children={props.children} element={props.element} />
    case 'ordered-list':
    ...
    default:
      return (
        <p css={{ textAlign: (props.element as any).textAlign }} {...props.attributes}>
          {props.children}
        </p>
      )
  }
